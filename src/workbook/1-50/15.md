...
const title = "My thoughts are images that I have made"
const reference = "W-15"
const pageNumber = 417
...
It is because the thoughts you think you think appear as images that you do not recognise them as nothing. 
...
They will not persist, because they merely symbolise true perception, and they are not related to knowledge. 
...
However, the idea can be applied as needed throughout the day. <acim-org-link pagenumber={{pageNumber}} reference={{reference}}></acim-org-link>