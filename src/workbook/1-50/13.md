---js
const prev = "/workbook/1-50/12"
const next = "/workbook/1-50/14"
const title = "A meaningless world engenders fear"
const chapter = 13
const pageNumber = 415
const volume = "W"
...
This is our first attempt at stating an explicit cause and effect relationship of a kind which you are very inexperienced in recognizing. Do not dwell on the concluding statement, and try not even to think of it except during the practice periods. That will suffice at present. {% render "acim-org-link", pageNumber: pageNumber, reference: reference  %}