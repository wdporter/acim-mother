...
This idea will help to release me from all that I now believe. {.mx-12 .italic}
...
My thought about _________ does not mean anything. {.mx-12  .italic}
...
<p class="mx-12 italic">This idea will help to release me from all that I now believe. {% render "acim-org-link", pageNumber: pageNumber, reference: reference  %}</p>