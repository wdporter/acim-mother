...
This idea will help to release me from all that I now believe. {.ml-12! .mr-12! .italic}
...
My thought about _________ does not mean anything. {.ml-12! .mr-12!  .italic}
...
[comment]: # (the single line with acim-link doesn't play well with the markdown attribute)
<p class="ml-12! mr-12! italic">This idea will help to release me from all that I now believe. {% render "acim-org-link", pageNumber: pageNumber, reference: reference  %}</p>