---js
const prev = "/workbook/1-50/18"
const next = "/workbook/1-50/20"
const title = "I am not alone in experiencing the effects of my thoughts"
const chapter = 19
const pageNumber = 421
const volume = "W"
...
*I am not alone in experiencing the effects of this thought about _____________.* {.ml-12! .mr-12!}
...
Apart from the “as needed” application of today’s idea, at least three practice periods are required, shortening the length of time involved, if necessary. Do not attempt more than four. {% render "acim-org-link", pageNumber: pageNumber, reference: reference  %}
