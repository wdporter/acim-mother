...
It is like the things I see in this room [on this street, and so on]. {.ml-12! .mr-12! .italic}
...
Further, since these exercises are the first of their kind, you may find the suspension of judgment in connection with thoughts particularly difficult. Do not repeat these exercises more than three or four times during the day. We will return to them later. {% render "acim-org-link", pageNumber: pageNumber, reference: reference  %}