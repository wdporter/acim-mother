...
const prev = "/workbook/61-80/63"
const next = "/workbook/61-80/65"
---
...
Our longer practice period today has as its purpose your acceptance of the fact that not only is there a very real connection between the function God gave you and your happiness, but that they are actually identical. God gives you only happiness. Therefore, the function She gave you must be happiness, even if it appears to be different. Today’s exercises are an attempt to go beyond these differences in appearance, and recognize a common content where it exists in truth.
...
Therefore my function must be happiness. {.ml-12! .mr-12! .italic}
...
The first premise is that God gives you only happiness. This could be false, of course, but in order to be false it is necessary to define God as something She is not. Love cannot give evil, and what is not happiness is evil. God cannot give what She does not have, and She cannot have what She is not. Unless God gives you only happiness, She must be evil. And it is this definition of Her you are believing if you do not accept the first premise.
...
Thus, it must be that your function is established by God through Her Voice, or is made by the ego which you have made to replace Her. Which is true? Unless God gave your function to you, it must be the gift of the ego. Does the ego really have gifts to give, being itself an illusion and offering only the illusion of gifts?
...
My happiness and function are one, because God has given me both. {.ml-12! .mr-12! .italic}

It will not take more than a minute, and probably less, to repeat these words slowly and think about them a little while as you say them. {% render "acim-org-link", pageNumber: pageNumber, reference: reference  %}