---js
const prev = "/manual/4/iii"
const next = "/manual/4/v"
const section = "IV"
const title = "Gentleness"
const pageNumber = 810
const chapter = "M-4"
