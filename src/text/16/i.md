...
To empathize does not
mean to join in *suffering*, for that is what you must
*refuse* to understand. That is the *ego’s*
...
it in His way. [His way is very different.] He does not understand
...
another ego. He does not join in pain, knowing that healing pain is
not accomplished by delusional attempts to enter into it and lighten
it by sharing the delusion.

The clearest proof that
empathy as the ego uses it is destructive lies in the fact that it is
applied only to certain types of problems and in certain people.
These it selects *out* and joins *with*. And it never joins
except to strengthen *itself.* [Having identified with what it
*thinks* it understands, it sees *itself* and would
...
*keep*. Do not use empathy to make the past real and so
perpetuate it. Step gently aside and let the healing be done
*for* you. Keep but one thought in mind and do not lose sight of
it, however tempted you may be to judge any situation and to
determine your response *by* judging it. Focus your mind only on
this:
